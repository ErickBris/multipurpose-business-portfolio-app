...
array(
			'name' => 'idCategory',
			'type' => 'raw',
			'value' => $model->idCategory !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->idCategory)), array('galleryCategory/view', 'id' => GxActiveRecord::extractPkValue($model->idCategory, true))) : null,
			),
array(
	'name'=>'image',
	'type'=>'html',
